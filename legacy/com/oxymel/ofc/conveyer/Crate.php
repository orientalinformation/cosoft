...
class Crate extends ConveyerTemplate {
	...
	{
		$me = new self();
		parent::constructor__D_D_S($he, $wi, $productShape);
	...
	{
		$me = new self();
		parent::constructor__D_D_D_D_S($height, $width, $productHeight, $productWidth, $productShape);
		$me->setCoordinateLegend(parent::$NAME_LEGENDS[$unity]);
		return $me;
	}
	...
	{
		$me = new self();
		parent::constructor__D_D_D_D_S_D_D($height, $width, $productHeight, $productWidth, $productShape, $heightInterval, $widthInterval);
		$me->setCoordinateLegend(parent::$NAME_LEGENDS[$unity]);
		return $me;
	}
	...
	{
		$me = new self();
		parent::constructor__D_D_D_D_S_D_D_D_D($height, $width, $productHeight, $productWidth, $productShape, $heightInterval, $widthInterval, $heightEdge, $widthEdge);
		return $me;
	}
