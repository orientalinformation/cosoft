...
class ConveyerBelt extends ConveyerTemplate {
    ...
    {
        $me = new self();
        parent::constructor__D_D_S(self::$HEIGHT_LEGENDS[$unity], $width, $productShape);
    ...
    {
        $me = new self();
        parent::constructor__D_D_D_D_S(self::$HEIGHT_LEGENDS[$unity], $width, $productHeigth, $productWidth, $productShape);
        $me->setCoordinateLegend(parent::$NAME_LEGENDS[$unity]);
        return $me;
    }
    ...
    {
        $me = new self();
        parent::constructor__D_D_D_D_S_D_D(self::$HEIGHT_LEGENDS[$unity], $width, $productHeight, $productWidth, $productShape, $heightInterval, $widthInterval);
        $me->setCoordinateLegend(parent::$NAME_LEGENDS[$unity]);
        return $me;
    }
    ...
    {
        $me = new self();
        parent::constructor__D_D_D_D_S_D_D_D_D(self::$HEIGHT_LEGENDS[$unity], $width, $productHeight, $productWidth, $productShape, $heightInterval, $widthInterval, $heightEdge, $widthEdge);
        $me->setCoordinateLegend(parent::$NAME_LEGENDS[$unity]);
        return $me;
    }
    ...
    {
        $me = new self();
        parent::constructor__D_D_S($height, $width, $productShape);
