...
class EquipGeneration extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['ID_EQUIPGENERATION', 'ID_EQUIP', 'ID_ORIG_EQUIP1', 'ID_ORIG_EQUIP2', 'AVG_PRODINTEMP', 'TEMP_SETPOINT', 'DWELLING_TIME', 'MOVING_CHANGE', 'MOVING_POS', 'ROTATE', 'POS_CHANGE', 'NEW_POS', 'EQP_GEN_STATUS', 'EQP_GEN_LOADRATE', 'FAN_FRENQUENCY'];
