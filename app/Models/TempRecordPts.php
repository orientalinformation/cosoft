...
class TempRecordPts extends Model
{
    ...
    protected $casts = [
        'AXIS1_PT_TOP_SURF' => 'float',
        'AXIS2_PT_TOP_SURF' => 'float',
        'AXIS3_PT_TOP_SURF' => 'float',
        'AXIS1_PT_INT_PT' => 'float',
        'AXIS2_PT_INT_PT' => 'float',
        'AXIS3_PT_INT_PT' => 'float',
        'AXIS1_PT_BOT_SURF' => 'float',
        'AXIS2_PT_BOT_SURF' => 'float',
        'AXIS3_PT_BOT_SURF' => 'float',
        'AXIS2_AX_1' => 'float',
        'AXIS3_AX_1' => 'float',
        'AXIS1_AX_2' => 'float',
        'AXIS3_AX_2' => 'float',
        ...
        'AXIS3_PL_1_2' => 'float',
        'NB_STEPS' => 'integer',
        'CONTOUR2D_TEMP_MIN' => 'float',
        'CONTOUR2D_TEMP_MAX' => 'float'
    ];
