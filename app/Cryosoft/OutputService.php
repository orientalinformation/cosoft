        ...
        if ($axeTempRecordData[$selectedAxe][2] == -1.0) {
            switch ($shape) {
                ...
                case 9: 
                    ...
                    $result = TempRecordData::where("ID_REC_POS", $idRecPos)->where('REC_AXIS_Y_POS', $rMeshPosition->REC_AXIS_Y_POS)->where('REC_AXIS_Z_POS', 0)->orderBy('REC_AXIS_X_POS', 'ASC')->get();
